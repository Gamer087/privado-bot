    ...
    try:
        ...
        if cloudtype == 'moodle':
            ...
            if loged:
                ...
                bot.editMessageText(message,'✖️ERROR AL CONECTAR CON LA NUBE✖️')
...
def onmessage(update,bot:ObigramClient):
    try:
        ...
        if '/add' in msgText:
            ...
            if isadmin:
                try:
                    ...
                    jdb.save()
                    msg = '👤Ahora @'+user+' tiene acceso como [USUARIO]'
        ...
        if '/admin' in msgText:
            ...
            if isadmin:
                try:
                    ...
                    jdb.save()
                    msg = '👑Ahora @'+user+' tiene acceso como [ADMIN]'
                    bot.sendMessage(update.message.chat.id,msg)
                except:
        ...
        if '/prueba' in msgText:
            ...
            if isadmin:
                try:
                    ...
                    jdb.save()
                    msg = '👤Ahora @'+user+' tiene acceso en [MODO PRUEBA]'
                    bot.sendMessage(update.message.chat.id,msg)
                except:
        ...
        if '/start' in msgText:
            ...
            start_msg+= '🆚Version del Bot: PRIVATE\n'
